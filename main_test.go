...
func TestProcessPath(t *testing.T) {
	...
	assert.Equal(t, &main.TODO{Assignee: "my.weird-email_address+1@email.com", Line: 11, Message: []string{"This is a named TODO"}, Filename: "tests/level1/level2.go"}, todos[1])
	assert.Equal(t, &main.TODO{Assignee: "quentin renard", Line: 16, Message: []string{"Here is another", "multi line todo"}, Filename: "tests/level1/level2.go"}, todos[2])
